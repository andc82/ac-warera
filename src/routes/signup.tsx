        ...
        <Card>
          ...
          <CardContent>
            <form onSubmit={onSubmit} className="space-y-3">
              ...
              <Field label="UserId (War Era)"><Input required value={form.warera_user_id} onChange={set("warera_user_id")} placeholder="es. 6512a3f9b1c4d8e7f0a92b5d" /></Field>
              <Field label="API Key (War Era)"><Input required value={form.api_key} onChange={set("api_key")} placeholder="wae_…" /></Field>
